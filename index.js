...
\`\`\`
┏────────────────────────────⊰
│ꪶ あ ꫂ 𝗕𝗢𝗧 𝗝𝗔𝗦𝗘𝗕 𝗡𝗔𝗜𝗟𝗢𝗡𝗚 𝗕𝗬 𝗗𝗫
┗────────────────────────────⊰
( 👋🏻 ) - Olaa Omm!\nI Am Nailong Bot Version 2.0 By DilxzzModz

╭────────────────────────────>
├── 𝗡𝗔𝗜𝗟𝗢𝗡𝗚 𝗕𝗢𝗧 𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗧𝗜𝗢𝗡 🤖
├── 👤 𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 : @DILXZZSTORE
├── 🐣 𝗩𝗲𝗿𝘀𝗶𝗼𝗻 𝗕𝗼𝘁 : 2.0 
├── ⚙ 𝗦𝗰𝗿𝗶𝗽𝘁 𝗡𝗮𝗺𝗲 : 𝗡𝗮𝗶𝗹𝗼𝗻𝗴 𝗕𝗼𝘁 𝗩𝟮.𝟬
├── 🤖 𝗠𝗮𝘂 𝗕𝘂𝘆 𝗦𝗰 𝗡𝗮𝗶𝗹𝗼𝗻𝗴? 𝗣𝘃 
├── ╰➤ @DILXZZSTORE 𝗠𝘂𝗿𝗺𝗲𝗿 𝗬𝗴𝘆 😈
    ...
    ? {
        inline_keyboard: [
          ...
          [
            ...
            { text: '📢 Informasi bot', url: 'https://t.me/dilxzzofficial' } // <-- Jangan di hapus hargai Developer
          ]
        ]
      }
    : undefined;
